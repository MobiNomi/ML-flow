...
# now with the autolog() function, we don't need to manually log parameters, metrics, and models.
# It will automatically log them for us.
# We can still log artifacts like the confusion matrix manually if we want to.
